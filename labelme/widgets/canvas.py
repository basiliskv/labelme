...
from ._canvas_interaction import ContextMenuPair
from ._canvas_interaction import CursorRole
from ._canvas_interaction import HitKind
from ._canvas_interaction import cursor_shape_for
from ._canvas_interaction import find_hover_target
from ._canvas_interaction import is_within_pick_threshold
...
class Canvas(QtWidgets.QWidget):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # noqa: ANN401
        ...
        self._palette_cache = {}
        self.context_menus = ContextMenuPair(
    ...
    def _apply_cursor(self, role: CursorRole) -> None:
        if role == self._cursor:
            return
        shape = cursor_shape_for(role=role)
